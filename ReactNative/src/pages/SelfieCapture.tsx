...
import { startContour, onContourClosed, ContourModel, onEventCaptured, onSelfieCaptured } from 'contour-ai-sdk';
...
export default function SelfieCapture() {
  ...
  onSelfieCaptured((selfie: any) => {
    const selfieUri = selfie.selfieUri;
    if (selfieUri) {
  ...
  return (
    <>
      <View style={styles.container}>
        <Text style={styles.checkSideLabel}>Selfie</Text>
        <TouchableOpacity
